...
const ProjectDetails: React.FC = () => {
    ...
    return (
        <div className={classes.ProjectDetails}>
            ...
            <div className={classes.header}><h1>{selectedProject.name}</h1></div>
            ...
            <div className={classes.imageAndTechContainer}>
                ...
                <div className={classes.technologiesUsed}>
                    ...
                    <div className={portfolioPageClasses.technologiesUsedContainer}>
                        {selectedProject.technologies.map(technology => (
                            <div className={portfolioPageClasses.technology}>
                                <div className={portfolioPageClasses.imageContainer}>
            ...
            <div className={classes.textAndButtonsContainer}>
                <div className={classes.textContainer}>
                    <p dangerouslySetInnerHTML={{__html: selectedProject.textLong}} />
