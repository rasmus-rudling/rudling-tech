...
export const projects: Projects = {
	...
	"Rudling Tech": {
		...
		textLong: `I've created this website mainly to have a place where I can showcase my previous work. But also to be able to write 
	...
	ShareTunes: {
		name: "ShareTunes",
		text: "A musical sharing social media website where you can create a profile and share your favorite music with friends.",
		textLong: `A musical sharing social media website where you can create a profile and share your favorite music with 
        friends. You can both comment, like, create posts and follow other users and listen to previews of songs fetched from 
        the Spotify API.`,
		bullets: [
			`I spent a lot of time working with Spotify's API. This broadened my understanding of web development a lot.`,
			`I took a big responsibility for the backend of this project. Since our application had a lot of dynamic content based 
...
export const svEnProjects: SvEnProjects = {
	...
	"Learn AI": {
		...
		textLong: {
            ...
            av de grundläggande begreppen AI. Därför bestämde jag mig för att skapa denna webbplats. Dels för mitt eget 
	...
	"Chapter Website": {
		...
		textLong: {
            ...
            Technology Chapter at KTH. Worked mostly on the document page, allowing our chapter members to 
            find documents faster. Also worked on the event page, allowing chapter members to find all the 
            available events in one place. Previously, the events were spread out on Facebook.`,
		...
		bullets: [
			...
			{
				sv: "När vi var färdiga med den första versionen av webbplatsen blev det ett projekt med öppen källkod.",
	...
	"Rudling Tech": {
		...
		textLong: {
			sv: `Jag har skapat denna webbplats främst för att ha en plats där jag kan visa upp mitt tidigare arbete. Men
